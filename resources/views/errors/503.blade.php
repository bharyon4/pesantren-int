...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="/image/7d.ico" type="image/x-icon">
        <link rel="stylesheet" href="{{ asset('css/style.css') }}">
    </head>
    <div class="auth-wrapper maintance" style="background: #f6f7fb;">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="text-center">
                        <div class="">
                            <svg id="aa03ddf9-f8f2-4819-a4ce-be9b0a220741" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1119.60911 699">
                                ...
                                <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356" transform="translate(-31.39089 -100.5)" fill="#4099ff" />
                                <path d="M70.77521,158.66768c0,73.61476,31.00285,133.18288,69.31641,133.18288" transform="translate(-31.39089 -100.5)" fill="#4099ff" />
                                ...
                                <rect x="271.60911" y="150" width="16" height="16" fill="#4099ff" opacity="0.4" />
                                <rect x="294.60911" y="150" width="16" height="16" fill="#4099ff" opacity="0.8" />
                                <rect x="317.60911" y="150" width="16" height="16" fill="#4099ff" />
                                <rect x="271.60911" y="251" width="16" height="16" fill="#4099ff" opacity="0.4" />
                                <rect x="294.60911" y="251" width="16" height="16" fill="#4099ff" opacity="0.8" />
                                <rect x="317.60911" y="251" width="16" height="16" fill="#4099ff" />
                                <rect x="271.60911" y="352" width="16" height="16" fill="#4099ff" opacity="0.4" />
                                <rect x="294.60911" y="352" width="16" height="16" fill="#4099ff" opacity="0.8" />
                                <rect x="317.60911" y="352" width="16" height="16" fill="#4099ff" />
                                ...
                                <path d="M271.36733,565.03228c-6.37889-28.56758,14.01185-57.43392,45.544-64.47477s62.2651,10.41,68.644,38.9776-14.51861,39.10379-46.05075,46.14464S277.74622,593.59986,271.36733,565.03228Z" transform="translate(-31.39089 -100.5)" fill="#4099ff" />
                        ...
                        <h3 class="my-4">Site Under Maintenance!</h3>
                        <h5>Our site is getting a little tune up </h5>
                    </div>
                </div>
            </div>
        </div>
